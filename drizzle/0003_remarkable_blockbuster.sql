...
ALTER TABLE "todo-agent_block" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_checkbox" ADD COLUMN "blockId" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_checkbox" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_heading" ADD COLUMN "blockId" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_heading" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_link" ADD COLUMN "blockId" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_link" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_list" ADD COLUMN "blockId" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_list" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_paragraph" ADD COLUMN "blockId" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "todo-agent_paragraph" ADD COLUMN "displayOrder" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
